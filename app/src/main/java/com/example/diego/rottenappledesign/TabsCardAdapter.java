...
/*
* Classe Adapter per le Cards dei Tabs che le costruisce e gestisce il comportamento di esse.
* @author RottenApple
* @version 1.0
*/

public class TabsCardAdapter extends RecyclerView.Adapter<TabsCardAdapter.ViewHolder> {
        ...
        public ViewHolder(View v) {
            ...
            action_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setMessage(save_box_text.getText());
                    builder.show();
                }
            });
    ...
    public TabsCardAdapter(List<CardContent> datalist) {
        mList = datalist;
    }

    // Metodo che crea nuove View, è invocato dal Layout Manager
    @Override
    public TabsCardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewtype) {
